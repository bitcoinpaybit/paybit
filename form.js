...
if (!window.emailjs) {
    ...
    script.onload = function() {
        ...
        injectForm();  // Inject the form after EmailJS is initialized
    };
} else {
    // EmailJS is already loaded, initialize it
    emailjs.init("UzvWE4cijC2AeexsY");
    injectForm();  // Inject the form
}

// Function to inject the form into the HTML
function injectForm() {
    const formHTML = `
    ...
    `;
    // Inject the form HTML into the div with id "formContainer"
